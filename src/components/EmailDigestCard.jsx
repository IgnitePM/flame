  ...
  return (
    <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm text-left">
      ...
      <p className="text-slate-400 text-sm font-medium mb-6">
        ...
        ending soon with unused balance, recent assignment notices, @mentions from
        notes across the app, and (if Sales Funnel is enabled) sales follow-ups.
        Daily around 8am Toronto on weekdays; weekly on Mondays. Assignment alerts
        also check every 15 minutes and email only when someone was newly assigned
        a task. Requires{' '}
